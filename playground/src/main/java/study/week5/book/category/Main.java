package study.week5.book.category;
...
public class Main {
    public static void main(String[] args) {
        ...
        bookList.stream()
            ...
            .forEach(book -> System.out.println("카테고리가 여행인 제목: " + book.getBookName()));
        ...
        bookList.stream()
            ...
            .forEach(book -> System.out.println("가격 16200원 이하 책 제목:" + book.getBookName()));
        ...
        bookList.stream()
            ...
            .forEach(book -> System.out.println("책 제목에 '경제'가 포함된 책 제목:" + book.getBookName()));
        ...
        System.out.println("카테고리 IT 책들의 가격 합: " + sumPrice);
        System.out.println();

        // 조건 6
        List<Book> discountBookList = bookList.stream()
            .filter(book -> book.getCategory().equals("IT"))
            .peek(book -> book.setPrice(book.getPrice() * 0.6))
            .toList();

        for (Book discountBook : discountBookList) {
            System.out.println("할인된 책 제목: " + discountBook.getBookName());
            System.out.println("할인된 책 가격 " + discountBook.getPrice());
        }
    }
}
